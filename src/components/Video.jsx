        ...
        <div className="video">
            <div className="left">
                ...
                <div className="video-info">
                    <div className="title-container">
                        <span className="video__title">voy a pelear con todos 😎</span>
                    </div>
                    <div className="info">
                        <div className="statistics">
                            <span className="views">1.075.437 visualizaciones  </span>
                            <span className="date">25 ene 2022</span>
                        </div>
                        <div className="actions">
                            <div className="likes">
                                ...
                                <span className="likes__data">99.183</span>
                            </div>
                ...
                <div className="meta">
                    <div className="channel-icon-container">
                        <img className="channel-icon" src="https://yt3.ggpht.com/ytc/AKedOLT5dAI3K_f_yqNwjsD4IXqcDsEPo_U4C2EGO9ZqJw=s48-c-k-c0x00ffffff-no-rj" alt="channelIcon" />
                    </div>
                    <div className="meta-info">
                        <div className="channel-info">
                            <div className="channel">
                                <span className="channel__name">Spreen</span>
                                <span className="channel__suscribers">1,76 M de suscriptores</span>
                            </div>
                ...
                <div className="comments">
                    ...
                    <ul className="list">
                        <li className="list__item">
                            <img className="list__icon" src="https://yt3.ggpht.com/yti/APfAmoFpVtcb0GhsT8w_ftVTphuY9oPHZ7PbNV4Em-mGgA=s48-c-k-c0x00ffffff-no-rj" alt="userIcon" />
                            <div className="data">
                                <span className="data__channel">risk<span className="data__timeago"> hace 1 dia</span>
                                </span>
                                <span className="list__comment">Que humilde spreen reutilizando miniaturas para poder cuidar el medio ambiente, simplemente humilde.</span>
                                <div className="options">
                                    <div className="like">
                                        ...
                                        <span className="like__count">2694</span>
                                    </div>
                        ...
                        <li className="list__item">
                            <img className="list__icon" src="https://yt3.ggpht.com/yti/APfAmoFpVtcb0GhsT8w_ftVTphuY9oPHZ7PbNV4Em-mGgA=s48-c-k-c0x00ffffff-no-rj" alt="userIcon" />
                            <div className="data">
                                <span className="data__channel">GTFO hace 19 horas</span>
                                <span className="list__comment">Grandiosa entrevista a toda la hinchada de platense.</span>
                                <div className="options">
                                    <div className="like">
                                        <svg className="likes__icon" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g><path d="M18.77,11h-4.23l1.52-4.94C16.38,5.03,15.54,4,14.38,4c-0.58,0-1.14,0.24-1.52,0.65L7,11H3v10h4h1h9.43 c1.06,0,1.98-0.67,2.19-1.61l1.34-6C21.23,12.15,20.18,11,18.77,11z M7,20H4v-8h3V20z M19.98,13.17l-1.34,6 C18.54,19.65,18.03,20,17.43,20H8v-8.61l5.6-6.06C13.79,5.12,14.08,5,14.38,5c0.26,0,0.5,0.11,0.63,0.3 c0.07,0.1,0.15,0.26,0.09,0.47l-1.52,4.94L13.18,12h1.35h4.23c0.41,0,0.8,0.17,1.03,0.46C19.92,12.61,20.05,12.86,19.98,13.17z"></path></g></svg>
                                        <span className="like__count">251</span>
                                    </div>
                                    <div className="dislike">
                                        <svg className="dislikes__icon" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g><path d="M17,4h-1H6.57C5.5,4,4.59,4.67,4.38,5.61l-1.34,6C2.77,12.85,3.82,14,5.23,14h4.23l-1.52,4.94C7.62,19.97,8.46,21,9.62,21 c0.58,0,1.14-0.24,1.52-0.65L17,14h4V4H17z M10.4,19.67C10.21,19.88,9.92,20,9.62,20c-0.26,0-0.5-0.11-0.63-0.3 c-0.07-0.1-0.15-0.26-0.09-0.47l1.52-4.94l0.4-1.29H9.46H5.23c-0.41,0-0.8-0.17-1.03-0.46c-0.12-0.15-0.25-0.4-0.18-0.72l1.34-6 C5.46,5.35,5.97,5,6.57,5H16v8.61L10.4,19.67z M20,13h-3V5h3V13z"></path></g></svg>
                                    </div>
                        ...
                        <li className="list__item">
                            <img className="list__icon" src="https://yt3.ggpht.com/yti/APfAmoFpVtcb0GhsT8w_ftVTphuY9oPHZ7PbNV4Em-mGgA=s48-c-k-c0x00ffffff-no-rj" alt="userIcon" />
                            <div className="data">
                                <span className="data__channel">risk hace 19 horas</span>
                                <span className="list__comment">Grandiosa entrevista a toda la hinchada de platense.</span>
                                <div className="options">
                                    <div className="like">
                                        <svg className="likes__icon" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g><path d="M18.77,11h-4.23l1.52-4.94C16.38,5.03,15.54,4,14.38,4c-0.58,0-1.14,0.24-1.52,0.65L7,11H3v10h4h1h9.43 c1.06,0,1.98-0.67,2.19-1.61l1.34-6C21.23,12.15,20.18,11,18.77,11z M7,20H4v-8h3V20z M19.98,13.17l-1.34,6 C18.54,19.65,18.03,20,17.43,20H8v-8.61l5.6-6.06C13.79,5.12,14.08,5,14.38,5c0.26,0,0.5,0.11,0.63,0.3 c0.07,0.1,0.15,0.26,0.09,0.47l-1.52,4.94L13.18,12h1.35h4.23c0.41,0,0.8,0.17,1.03,0.46C19.92,12.61,20.05,12.86,19.98,13.17z"></path></g></svg>
            ...
            <div className="right">
                ...
                <div className="related-videos">
                    <ul className="list">
                        <li className="list__item">
                            <img className="list__thumbnail" src="https://i.ytimg.com/vi/tf-vufUtJeI/hqdefault.jpg?sqp=-oaymwEbCKgBEF5IVfKriqkDDggBFQAAiEIYAXABwAEG&rs=AOn4CLDprYAKujW4nlZ-M2TZqKsn-VGVPA" alt="thumbnail" />
                            <div className="data">
                                <span className="list__title">broma sale mal</span>
                                <span className="list__channel-name">Spreen</span>
                                <span className="list__meta">7,6 M de visualizaciones *sdfsdfsdfds hace 18 horas</span>
                            </div>
                        </li>
                        <li className="list__item">
                            <img className="list__thumbnail" src="https://i.ytimg.com/vi/tf-vufUtJeI/hqdefault.jpg?sqp=-oaymwEbCKgBEF5IVfKriqkDDggBFQAAiEIYAXABwAEG&rs=AOn4CLDprYAKujW4nlZ-M2TZqKsn-VGVPA" alt="thumbnail" />
